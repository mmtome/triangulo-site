...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Triangulo Solutions" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { title: "Triângulo Solutions | Tecnologia e Gestão em Uberaba/MG" },
      { property: "og:title", content: "Triângulo Solutions | Tecnologia e Gestão em Uberaba/MG" },
      { name: "twitter:title", content: "Triângulo Solutions | Tecnologia e Gestão em Uberaba/MG" },
